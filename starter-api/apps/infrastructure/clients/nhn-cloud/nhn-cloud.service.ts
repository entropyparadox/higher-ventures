...
export class NhnCloudService {
  ...
  private EMAIL_APP_KEY: string;
  private EMAIL_SECRET_KEY: string;

  // Alimtalk
  private ALIMTALK_HOST = 'https://api-alimtalk.cloud.toast.com';
  private ALIMTALK_SENDER_KEY: string;
  private ALIMTALK_APP_KEY: string;
  private ALIMTALK_SECRET_KEY: string;
